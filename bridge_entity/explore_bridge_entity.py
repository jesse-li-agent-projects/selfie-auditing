"""Browse one bridge-entity sweep question by question, generations included.
    ...
    python -m bridge_entity.explore_bridge_entity --run bridge_entity/bg_think_many
    cd outputs/bridge_entity/bg_think_many_explorer && python -m http.server
...
def parse_args(argv=None):
    ...
    parser.add_argument(
        ...
        default="bridge_entity/bg_think_many",
    ...
    parser.add_argument(
        "--output-dir",
        type=outputs_relative,
        default="bridge_entity/bg_think_many_explorer",
